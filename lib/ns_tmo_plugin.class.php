...
class NS_TMO_Plugin {
	...
	/**
	 * reordered function variables to suit php 8.1 by FGS 12-2-2023
	 */
	public function add_column_value ($custom_column, $term_id, $empty = '') {
	...
	/**
	 * Declared as Static by FGS 12-2-2023
	*/
